 ...
 */
public interface EditableBusinessObject extends SupportUndo, UndoableObject, BusinessObject, Savable, Cloneable {
	 ...
	 * 
	 *        @remark Altering this value will almost certainly break your code. This
	 * property is for use by the parent collection only!
	 */
	 ...
	 * is saved to the database. This property indicates whether or not the current
	 ...
	 * into the database. All new objects are considered dirty. All objects marked for
	 ...
	 * (key) value doesn't correspond to data in the database. In other words, if the
